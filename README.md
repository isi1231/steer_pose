...
| 数据集 | 物种 | 用途 |
|--------|------|------|
| [MAMMAL](https://github.com/AniMesH/three-dimensional-surface-motion-capture-of-multiple-freely-moving-pigs) | 巴马猪、比格犬（多实例） | 与猪场场景最相关，训练 class-specific |
| Animal3D | 40 种四足动物 | 训练 class-agnostic 模型，可泛化到新物种 |
| AcinoSet | 猎豹 | 野外单实例 |
| 3D-PoP | 鸽子（多实例） | 鸟类 |
| CMU Panoptic | 人类 | 人类 |
